package hy.game.png
{
	...
	public class SJpegEncoder
	{
		...
		public function SJpegEncoder(quality:Number = 50)
		{
			if (quality <= 0) {
				quality = 1;
			}
		...
		public function encodeAsync(image : BitmapData, callback : Function, outputByteArray : ByteArray = null) : void
		{
			...
			var SAsyncScheduler : * = getDefinitionByName("com.sunny.game.engine.system.SAsyncScheduler");
			SAsyncScheduler.async(this, function(timeout : int) : Boolean
			{
				// Encode 8x8 macroblocks
