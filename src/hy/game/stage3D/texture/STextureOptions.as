package hy.game.stage3D.texture
{
    ...
    public class STextureOptions
    {
        ...
        public function STextureOptions(scale:Number=1.0, mipMapping:Boolean=false, 
        ...
        public function clone():STextureOptions
        {
            var clone:STextureOptions = new STextureOptions(mScale, mMipMapping, mFormat, mRepeat);
